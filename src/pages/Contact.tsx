        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16">
          ...
          >
            <a
              ...
              className="group flex items-center gap-3 sm:gap-5 p-4 sm:p-6 bg-light-beige/50 rounded-2xl hover:bg-light-beige hover:shadow-card transition-all duration-500"
            >
              <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-xl bg-warm-white flex items-center justify-center shadow-xs group-hover:bg-muted-sage group-hover:text-warm-white transition-smooth">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <a
                ...
                download
                className="group flex items-center gap-3 sm:gap-4 p-4 sm:p-5 bg-charcoal rounded-2xl hover:bg-charcoal/90 transition-all duration-500"
              >
              ...
              <a
                ...
                download
                className="group flex items-center gap-3 sm:gap-4 p-4 sm:p-5 bg-light-beige rounded-2xl hover:bg-muted-sage/20 transition-all duration-500 border border-light-beige"
              >
          ...
          >
            <div className="bg-light-beige/40 rounded-3xl p-5 sm:p-8">
            ...
            <div className="bg-warm-white rounded-2xl p-4 sm:p-6 border border-light-beige">
