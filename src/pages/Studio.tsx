        ...
        {isBookOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-warm-white rounded-t-3xl sm:rounded-3xl max-w-4xl w-full max-h-[calc(100dvh-4.5rem)] sm:max-h-[calc(100dvh-8rem)] overflow-y-auto modal-scrollbar-hidden shadow-2xl"
            >
