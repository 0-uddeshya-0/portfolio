          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-sm text-charcoal/70">
              ...
              <a
                ...
                className="underline-offset-4 hover:underline transition-colors text-charcoal hover:text-muted-sage"
              >
                {personalInfo.email}
              </a>
            </p>
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <a
                  ...
                  aria-label="GitHub"
                  className="text-charcoal/60 hover:text-charcoal opacity-80 hover:opacity-100 transition-smooth"
                >
